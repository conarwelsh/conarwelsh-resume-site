...
elixir(function(mix) {
    ...
    mix.copy('resources/assets/bower_components/jqlite/jqlite.1.1.1.js', 'public/vendor/jquery.js');
    mix.copy('resources/assets/bower_components/angular/angular.js', 'public/vendor/angular.js');
